...
namespace AdatbazisKapcsolat {
    ...
    public partial class Database1DataSet2 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string nev) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string nev {
                get {
                    return ((string)(this[this.tableTable.nevColumn]));
                }
                set {
                    this[this.tableTable.nevColumn] = value;
                }
            }
        }
...
namespace AdatbazisKapcsolat.Database1DataSet2TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([nev] = @Original_nev" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [nev]) VALUES (@Id, @nev);\r\nSELECT Id, nev FROM " +
                "[Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [nev] = @nev WHERE (([Id] = @Original_Id) AN" +
                "D ([nev] = @Original_nev));\r\nSELECT Id, nev FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AdatbazisKapcsolat.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nev FROM dbo.[Table]";
